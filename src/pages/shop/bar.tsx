    ...
    <SakoonLayout title="Bar">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 mt-16">
          <h1 className="text-5xl md:text-7xl font-rubik font-black uppercase tracking-widest drop-shadow-2xl mb-6">The Bar</h1>
          ...
          <p className="text-lg md:text-xl font-medium tracking-widest max-w-2xl mx-auto drop-shadow-md">
            Enjoy our signature cocktails, premium spirits, and wine selections.
          </p>
        </div>
      </section>

      <div className="py-24 max-w-7xl mx-auto">
        <ProductList categorySlug="bar" />
      </div>
    </SakoonLayout>
  );
}