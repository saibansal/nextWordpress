...
export default function About() {
  ...
  const title = page?.title?.rendered || "About Sakoon";

  return (
    <SakoonLayout title={page?.title?.rendered || "About Us"}>
      {/* Hero Banner Section */}
      ...
      <div className="py-24 px-6 md:px-16 max-w-4xl mx-auto text-center">
        <div className="bg-gray-50/50 p-8 md:p-12 rounded-3xl border border-gray-100 shadow-sm">
          {page?.content?.rendered ? (
            <div dangerouslySetInnerHTML={{ __html: page.content.rendered }} className="text-gray-600 leading-relaxed" />
          ) : (
            <>
